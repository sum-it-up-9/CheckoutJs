...
import ConditionalDropdownComponent from '../CustomShipping/ConditionalDropdownComponent';
...
> {
    ...
    private renderStep(step: CheckoutStepStatus): ReactNode {
        switch (step.type) {
            ...
            case CheckoutStepType.CustomShipping:
                return this.renderCustomShipping(step);    
    ...
    private renderCustomShipping(step: CheckoutStepStatus): ReactNode {
        ...
        return (
            <CheckoutStep
                {...step}
                heading={<TranslatedString id="Custom Shipping Method" />}
                key={step.type}
                onEdit={this.handleEditStep}
                onExpanded={this.handleExpanded}
                suggestion={<CheckoutSuggestion />}
            ...
            >
                <div>
                    ...
                    <ConditionalDropdownComponent cart={cart}/>
                </div>
            </CheckoutStep>
        );
    }
