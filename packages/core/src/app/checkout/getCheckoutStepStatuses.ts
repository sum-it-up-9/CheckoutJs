...
const getCustomStepStatus = createSelector(
    ({ data }: CheckoutSelectors) => data.getCheckout(),
    () => {
        const isComplete =  true;

        return {
            type: CheckoutStepType.CustomShipping,
            isActive: false,
            isComplete,
...
const getCheckoutStepStatuses = createSelector(
    ...
    (customerStep, shippingStep,customStep, billingStep, paymentStep) => {
        const steps = compact([customerStep, shippingStep,customStep, billingStep, paymentStep]);
